...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(
        'https://api.sheetbest.com/sheets/73add50f-a9b5-40da-8b96-e5c2966094aa'
        ,form
    ).then((response) => {
        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                ...
                <div className="contact__card">
                    ...
                    <p className="contact__card-data">zhong31415926@gmail.com</p>
                </div>
                ...
                <div className="contact__card">
                    ...
                    <p className="contact__card-data">0979804607</p>
                </div>
            </div>
